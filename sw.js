...
const CACHE_VERSION = 'v20260829-145';
...
const CACHE_FILES = [
  ...
  BASE + 'assets/css/paypay-tabs-base.css',
  BASE + 'assets/css/home-card-art.css',
  BASE + 'assets/css/home-card-art-core.css',
  BASE + 'assets/css/home-card-art-v2.css',
  BASE + 'assets/css/home-alignment-fix.css',
  BASE + 'assets/css/home-modern.css',
  BASE + 'assets/img/home-card-art-sprite.svg',
  BASE + 'assets/css/print.css',
  BASE + 'assets/js/print-util.js',
  BASE + 'assets/js/navigation.js',
  BASE + 'assets/js/home-modern.js',
  ...
  BASE + 'assets/illustrations/guild-all.svg',
  BASE + 'assets/illustrations/guild-work.svg',
  BASE + 'assets/illustrations/guild-tools.svg',
  BASE + 'assets/illustrations/guild-consult.svg',
  ...
  BASE + 'calendar.html',
  BASE + 'calc.html',
  BASE + 'kyosai_calc.html',
  BASE + 'disaster_support.html',
  BASE + 'atsusa.html',
  BASE + 'koushu.html',
  BASE + 'rodo36.html',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(
    fetch(event.request.mode === 'navigate' ? new Request(event.request,{cache:'no-store'}) : event.request)
      .then(response => {
