...
const CACHE_VERSION = 'v20260902-190';
...
const CACHE_FILES = [
  ...
  BASE + 'assets/illustrations/home-3d/training-v180.jpg', BASE + 'assets/illustrations/home-3d/merit-v180.jpg', BASE + 'assets/illustrations/home-3d/documents-v180.jpg', BASE + 'assets/illustrations/home-3d/youtube-v180.jpg', BASE + 'assets/illustrations/home-3d/disaster-v181.jpg', BASE + 'assets/illustrations/home-3d/watching-v190.jpg',
  ...
  BASE + 'assets/js/calendar-config.js', BASE + 'assets/js/calendar-upcoming.js', BASE + 'assets/js/guild-config.js', BASE + 'assets/js/guild-canonical-v199.js', BASE + 'assets/js/guild-template-v200.js', BASE + 'assets/js/guild-update-compat-v201.js', BASE + 'assets/js/bookshelf.js', BASE + 'assets/js/meishi.js', BASE + 'assets/js/qrcode-generator.js', BASE + 'assets/css/meishi.css',
