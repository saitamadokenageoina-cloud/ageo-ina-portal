...
const CACHE_FILES = [
  ...
  BASE + 'assets/js/calendar-config.js', BASE + 'assets/js/calendar-upcoming.js', BASE + 'assets/js/guild-config.js', BASE + 'assets/js/guild-display-hotfix-v197.js', BASE + 'assets/js/guild-config-v194.js', BASE + 'assets/js/guild-v195-loader.js', BASE + 'assets/js/guild-admin-editor-v195.js', BASE + 'assets/js/bookshelf.js', BASE + 'assets/js/meishi.js', BASE + 'assets/js/qrcode-generator.js', BASE + 'assets/css/meishi.css',
