(function(){
  ...
  function injectThemePolishStylesheet(){
    ...
    link.rel = 'stylesheet';
    link.href = 'assets/css/theme-polish.css?v=183';
  ...
  function injectHomeModernAssets(){
    ...
    if (!document.querySelector('link[data-home-modern]')) {
      var link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = 'assets/css/home-modern.css?v=183';
    ...
    if (!document.querySelector('link[data-home-card-art]')) {
      ...
      art.rel = 'stylesheet';
      art.href = 'assets/css/home-card-art.css?v=183';
    ...
    if (!document.querySelector('link[data-home-alignment-fix]')) {
      ...
      alignment.href = 'assets/css/home-alignment-fix.css?v=183';
    ...
    if (!document.querySelector('script[data-home-modern]')) {
      ...
      script.src = 'assets/js/home-modern.js?v=183';
